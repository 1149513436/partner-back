package com.oyh.partnerback.utils;
...
public class CodeGenerator {
    ...
    private static final String PACKAGE_NAME = "com.oyh.partnerback";
    private static final String AUTHOR = "Hrosy";

    /*=========================  下面的不用改动  =========================*/

    private static final String PROJECT_PATH ="D:\\IDEA_resouce\\partner-back\\";
    ...
    private static void generateJava(String tableName) {
        ...
        System.out.println("@@@@@@@@@@@@@@@"+PROJECT_PATH + JAVA_CODE_PATH);
